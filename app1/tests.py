...
class SendEmail:
    ...
    def send(self):
        ...
        for attach in self.attach_files:
            ...
            attach.add_header('Content-Disposition', 'attachment', filename=self.attach_title)
...
def mail():
    send_info = {
        ...
        'receivers': ['liutao-yunwei@mfhcd.com', 'yinhb@mfhcd.com'],
        'subject': 'cachecloud初始化脚本',
        'content_path': 'C:/Users/hoyin/Desktop/cachecloud-init.sh',
        'attach_files': ['C:/Users/hoyin/Desktop/新建XLSX工作表_11.xlsx'],
        'attach_title': '新建XLSX工作表_11.xlsx'
    }
